    ...
    public static class LoadSupportCalculator
    {
        public static LoadSupportResult Calculate(Pawn pawn)
        {
            ...
            try
            {
                ...
                float exponent = ParametricMod.Settings != null
                    ? ParametricMod.Settings.superhumanExponent
            ...
            catch (Exception ex)
            {
                ...
                Log.ErrorOnce(LoadSupportLog.Prefix + "Could not evaluate body of " + SafeLabel(pawn)
                              + "; using neutral LoadSupport 1.0. " + ex,
                              ("Parametric_LoadSupport_calc_" + pawn.thingIDNumber).GetHashCode());
                return LoadSupportResult.Neutral;
            }
        }

        public static string SafeLabel(Pawn pawn)
        {
